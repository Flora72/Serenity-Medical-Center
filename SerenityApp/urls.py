...
urlpatterns = [
    ...
    path('patients/<int:id>/edit/', views.patient_edit, name='patient_edit'),  # Add this line
    path('patients/<int:id>/update/', views.patient_update, name='patient_update'),  # Add this line
]
